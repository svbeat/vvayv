...
public class PhraseData {
    ...
    private static final String[][] rawArray_greeting = {
            {"greet1", "3", "Hello / Hi", "nĭ hăo", "你好", Integer.toString(R.raw.audio1)},
            {"greet2", "3", "Nice to meet you.", "hěn gāo xìng jiàn dào nĭ", "很高兴见到你.", Integer.toString(R.raw.audio4)},
            {"greet3", "3", "I am ...", "wŏ shì ...", "我是 ...", Integer.toString(R.raw.audio7)},
            {"greet4", "3", "I am from United States.", "wŏ cóng měi gó lái.", "我从美国来.", Integer.toString(R.raw.audio7)},
            {"greet5", "3", "Are you ...?", "nĭ shì ...?", "你是 ...?", Integer.toString(R.raw.audio10)},
            {"greet6", "4", "Goodbye.", "zài jiàn.", "再见.", Integer.toString(R.raw.audio20)},
            {"greet7", "2", "See you later.", "huí tóu jiàn", "回头见.", Integer.toString(R.raw.audio300)}
    };

    private static final String[][] rawArray_essential = {
            {"essential1", "4", "yes ... no", "shì ... bú shì", "是 ... 不是", Integer.toString(R.raw.audio1)},
            {"essential2", "3", "good ... bad", "hăo ... huài", "好 ... 坏", Integer.toString(R.raw.audio4)},
            {"essential3", "4", "up .. down ... left ... right", "shàng ... xià ... zuŏ ... yòu", "上 ... 下 ... 左 ... 右", Integer.toString(R.raw.audio7)},
            {"essential4", "3", "you ... I ... she/he", "nĭ ... wŏ ... tā", "你 ... 我 ... 他/她", Integer.toString(R.raw.audio10)},
            {"essential5", "3", "morning ... afternoon ... evening", "zăo shàng ... zhōng wŭ ... wăn shàng", "早上 ... 中午 ... 晚上", Integer.toString(R.raw.audio20)},
            {"essential6", "2", "food ... hungry", "shí wù ... è", "食物 ... 饿", Integer.toString(R.raw.audio300)},
            {"essential7", "3", "water ... thirsty", "shuĭ ... kě", "水 ... 渴", Integer.toString(R.raw.audio5000)}
    };
    ...
    private static final String[][] rawArray_askhelp = {
            {"askhelp1", "2", "Could you do me a favor?", "néng qĭng nĭ bāng gè máng ma?", "能请你帮个忙吗?", Integer.toString(R.raw.audio1)},
            {"askhelp2", "3", "Could you tell me where the bank is?", "qĭng wèn yín háng zài nă lĭ?", "请问银行在哪里?", Integer.toString(R.raw.audio4)},
            {"askhelp3", "3", "How can I get to the train station?", "qĭng wèn huŏ chē zhàn zěn mo zŏu?", "请问火车站怎么走?", Integer.toString(R.raw.audio7)},
            {"askhelp4", "3", "I would like a ticket to Beijing.", "wŏ yào zhāng qù běi jīng de piào.", "我要张去北京的票.", Integer.toString(R.raw.audio10)},
            {"askhelp5", "4", "Is this seat taken?", "zhè zuò wèi yŏu rén ma?", "这座位有人吗?", Integer.toString(R.raw.audio20)},
            {"askhelp6", "3", "When is the next bus? ", "qĭng wèn xià yí tàng chē shén mo shí hòu dào?", "请问下一趟车什么时候到?", Integer.toString(R.raw.audio300)},
            {"askhelp7", "4", "Thank you.", "xiè xiè nĭ.", "谢谢你.", Integer.toString(R.raw.audio5000)}
    };

    private static final String[][] rawArray_health = {
            {"health1", "3", "I’m sick.", "wŏ bìng le.", "我病了.", Integer.toString(R.raw.audio1)},
            {"health2", "3", "I have a fever.", "wŏ fā shāo le.", "我发烧了.", Integer.toString(R.raw.audio1)},
            {"health3", "1", "He’s got a bad headache.", "tā tóu téng de lì hài.", "他头痛的厉害.", Integer.toString(R.raw.audio4)},
            {"health4", "3", "I’ve got a pain in my back.", "wŏ bèi téng.", "我背疼.", Integer.toString(R.raw.audio7)},
            {"health5", "4", "It hurts right here.", "jiù zhè lĭ téng.", "就这里疼.", Integer.toString(R.raw.audio10)},
            {"health6", "4", "Call an ambulance!", "kuài jiào jiù hù chē!", "快叫救护车!", Integer.toString(R.raw.audio20)},
            {"health7", "4", "See the doctor.", "qù yī yuàn.", "去医院.", Integer.toString(R.raw.audio300)}
    };
